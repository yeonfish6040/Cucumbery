...
public class Sudo2 extends CommandBase
{
  ...
  static
  {
    ...
    Sudo2.commands = new String[commandList.size() * 2];
    for (int i = 0; i < commandList.size(); i++)
    {
      Sudo2.commands[i * 2] = commandList.get(i);
      Sudo2.commands[i * 2 + 1] = "op:" + commandList.get(i);
    }
  }
