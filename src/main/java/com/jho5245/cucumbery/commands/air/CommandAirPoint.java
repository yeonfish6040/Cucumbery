      ...
      switch (args[0].toLowerCase())
      {
        ...
        case "give" -> {
          ...
          else
          {
            ...
            if (!hideMessage)
            {
              MessageUtil.sendMessage(target, Prefix.INFO_AIR, SenderComponentUtil.senderComponent(sender) + "이 당신에게 산소를 &e" + value + "&r만큼 지급하였습니다 (&e산소량&r : &e" + target.getRemainingAir() + "&r / &e" + maxAir + "&r)");
