...
public class Yunnori implements CommandExecutor
{
    ...
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("&7낙..."), ComponentUtil.createTranslate("턴을 날려부려쓰..")));
    }
  }
  ...
  private void backDoe(final Player sender)
  {
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("&7빽도!"), ComponentUtil.createTranslate("뒤로 한 칸!")));
    }
  }
  ...
  private void doe(final Player sender)
  {
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("도!"), ComponentUtil.createTranslate("앞으로 한 칸!")));
    }
  }
  ...
  private void gae(final Player sender)
  {
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("개!"), ComponentUtil.createTranslate("앞으로 두 칸!")));
    }
  }
  ...
  private void geol(final Player sender)
  {
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("걸이요!"), ComponentUtil.createTranslate("앞으로 세 칸!")));
    }
  }
  ...
  private void yut(final Player sender)
  {
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("&a윷이요!"), ComponentUtil.createTranslate("#52ee52;앞으로 네 칸!")));
  ...
  private void mo(final Player sender)
  {
    for (Player player : Bukkit.getServer().getOnlinePlayers())
    {
      ...
      MessageUtil.sendMessage(player, Prefix.INFO_YUNNORI,
              ComponentUtil.createTranslate("%s님 %s %s",
                      ComponentUtil.senderComponent(sender), ComponentUtil.createTranslate("&b모!!!"), ComponentUtil.createTranslate("&c앞으로 다섯 칸!")));
