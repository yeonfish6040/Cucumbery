...
public class Reinforce implements CommandExecutor
{
	...
	enum ReinforceType
	{
		STARFORCE, SUPERIOR, CUCUMBERFORCE, EBEBEB
	}
	...
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args)
	{
		...
		if (!Method.hasPermission(player, Permission.CMD_REINFORCE, true))
			return true;
	...
	enum ItemType
	{
		SWORD, BOW, HELMET, CHESTPLATE, LEGGINGS, BOOTS, SHIELD, ETC
	}
	...
	@SuppressWarnings("unused") private static double[] calculate(double[] values, double itemRank)
	{
