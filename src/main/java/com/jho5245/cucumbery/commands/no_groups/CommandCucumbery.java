...
public class CommandCucumbery implements CucumberyCommandExecutor
{
  ...
  public @NotNull List<Completion> completion(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, @NotNull String[] args, @NotNull Location location)
  {
    ...
    if (length == 1)
    {
      return CommandTabUtil.tabCompleterList(args, "<인수>", false, "reload", "reloaddata", "reloadplugin", "version", "update", "update-quickshop-item", "update-customrecipe-item", "purge-user-data-files");
    }
