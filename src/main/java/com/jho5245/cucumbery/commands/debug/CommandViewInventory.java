...
public class CommandViewInventory implements CommandExecutor, TabCompleter
{
  public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label, String[] args)
  {
    ...
    if (args.length == 1)
    {
      ...
      else if (entity instanceof InventoryHolder inventoryHolder)
      {
        ...
        {
          Inventory clone = Bukkit.createInventory(null, 54, ComponentUtil.createTranslate("&8%s의 인벤토리 (복사본)", SenderComponentUtil.senderComponent(inventoryHolder, NamedTextColor.DARK_GRAY)));
      ...
      else if (entity instanceof LivingEntity livingEntity)
      {
        ...
        {
          Inventory inventory = Bukkit.createInventory(null, 18, ComponentUtil.createTranslate("&8%s이(가) 장착하고 있는 아이템", SenderComponentUtil.senderComponent(livingEntity, NamedTextColor.DARK_GRAY)));
