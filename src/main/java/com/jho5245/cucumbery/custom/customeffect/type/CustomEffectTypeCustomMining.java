...
public class CustomEffectTypeCustomMining extends CustomEffectType
{
  public static final CustomEffectType
          ...
          CUSTOM_MINING_SPEED_MODE_2 = new CustomEffectType("custom_mining_speed_mode_2", "채광 모드 2", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_2_NO_RESTORE = new CustomEffectType("custom_mining_speed_mode_2_no_restore", "채광 모드 2 (복구 없음)", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          ...
          CUSTOM_MINING_SPEED_MODE_2_NO_RESTORE_IGNORE_INSTA_BLOCKS = new CustomEffectType("custom_mining_speed_mode_2_no_restore_ignore_insta_blocks", "채광 모드 2 (복구 없음, 즉시 파괴 블록 무시)",
                  builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath().description("%s 효과가 있는 상태에서는 즉시 파괴되는 블록을 부술 땐 채광 모드를 무시합니다", CUSTOM_MINING_SPEED_MODE_2_NO_RESTORE)),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_DWARVEN_GOLDS = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_dwarven_golds", "채광 모드 커스텀 광물 - 드워프 금괴", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_TUNGSTENS = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_tungstens", "채광 모드 커스텀 광물 - 텅스텐", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_COBALTS = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_cobalts", "채광 모드 커스텀 광물 - 코발트", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_SHROOMITES = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_shroomites", "채광 모드 커스텀 광물 - 쉬루마이트", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_CUCUMBERITES = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_cucumberites", "채광 모드 커스텀 광물 - 오이스터늄", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_MITHRILS = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_mithrils", "채광 모드 커스텀 광물 - 미스릴", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_TITANIUMS = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_titaniums", "채광 모드 커스텀 광물 - 티타늄", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          CUSTOM_MINING_SPEED_MODE_PREDEFINED_CUSTOM_ORE_GEMSTONES = new CustomEffectType("custom_mining_speed_mode_predefined_custom_ore_gemstones", "채광 모드 커스텀 광물 - 젬스톤", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),

  CUSTOM_MINING_SPEED_MODE_ALLOWED_BLOCKS = new CustomEffectType("custom_mining_speed_mode_allowed_blocks", "채광 모드 특정 블록만 채광 허용", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
  CUSTOM_MINING_SPEED_MODE_ALLOWED_BLOCKS_MINE = new CustomEffectType("custom_mining_speed_mode_allowed_blocks_mine", "채광 모드 특정 블록만 채광 허용 (광산)", builder().defaultDisplayType(DisplayType.NONE).defaultDuration(2).keepOnDeath()),
          ...
          MINER_PVP = new CustomEffectType("miner_pvp", "채광 PvP 모드", builder().defaultDuration(2).defaultDisplayType(DisplayType.NONE)),

  MOVEMENT_CHECK = new CustomEffectType("custom_mining_movement_check", "", builder().hidden().defaultDuration(-1)),
  ...
  protected static void registerEffect()
  {
    register(
            ...
            MINER_ARMOR_SET_EFFECT, MINER_PVP
    );
  }
}
