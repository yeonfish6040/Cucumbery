...
public class CustomEffectTypeReinforce extends CustomEffectType
{
  ...
  {
    register(
            STARFORCE_30_SALE, STARFORCE_5_10_15, REINFORCE_OP_MODE, STARFORCE_ANTI_DESTRUCTION, ANTI_DESTRUCTION_DISABLED_WARNING, STAR_CATCH_PREPARE, STAR_CATCH_PROCESS, STAR_CATCH_SUCCESS, STAR_CATCH_FINISHED
    );
  }
}
