    ...
    if (deathMessageApplicable(entity))
    {
      ...
      switch (cause)
      {
        ...
        case SUFFOCATION ->
        {
          ...
          {
            extraArgs.add(ComponentUtil.create(ItemStackUtil.getItemStackFromBlock(ItemStackUtil.getExactBlockFromWithLimited(entity.getEyeLocation(), Constant.OCCLUDING_BLOCKS))));
          }
        }
        case FALL ->
        {
