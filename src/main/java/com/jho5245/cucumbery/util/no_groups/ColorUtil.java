...
public class ColorUtil
{
  ...
  public ColorUtil(@NotNull Type type, @NotNull String s)
  {
    switch (type)
    {
      case HEX -> {
  ...
  {
    return new ColorUtil(Type.HEX, hex).getHexString();
  }

  public static String hex2hexa(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getHexStringWithAlpha();
  }

  public static String hex2rgb(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getRGBString();
  }

  public static String hex2rgba(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getRGBAString();
  }

  public static String hex2hsl(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getHSLString();
  }

  public static String hex2hsla(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getHSLAString();
  }

  public static String hex2ansi(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getANSIEscape();
  }

  public static String hex2mfc(String hex)
  {
    return new ColorUtil(Type.HEX, hex).getMFC();
  }

  // RGB => ?
  public static String rgb2rgb(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getRGBString();
  }

  public static String rgb2rgba(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getRGBAString();
  }

  public static String rgb2hex(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getHexString();
  }

  public static String rgb2hexa(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getHexStringWithAlpha();
  }

  public static String rgb2hsl(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getHSLString();
  }

  public static String rgb2hsla(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getHSLAString();
  }

  public static String rgb2ansi(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getANSIEscape();
  }

  public static String rgb2mfc(String rgb)
  {
    return new ColorUtil(Type.RGB, rgb).getMFC();
  }
  ...
  public static String getGradientString(List<ColorUtil> colors, String string)
  {
    ...
    for (int n = 0; n < colors.size() - 1; n++)
    {
      ...
      List<ColorUtil> gradient = getGradient(colors.get(n), colors.get(n + 1), gradientLength + 1);
  ...
  public static List<ColorUtil> getGradient(ColorUtil startColor, ColorUtil endColor, int length)
  {
    ...
    for (int n = 0; n < length; n++)
    {
      ...
      ColorUtil color = new ColorUtil(Type.RGB, r + "," + g + "," + b);
      colors.add(color);
    }
    return colors;
  }
  ...
  public static String chatHSL2MFC(@NotNull String s)
  {
    ...
    while (m.find())
    {
      s = s.replace(m.group(0), new ColorUtil(Type.HSL, m.group(0)).getMFC());
    }
    return s;
  }
  ...
  public static String chatCMYK2MFC(@NotNull String s)
  {
    ...
    while (m.find())
    {
      s = s.replace(m.group(0), new ColorUtil(Type.CMYK, m.group(0)).getMFC());
    }
    return s;
  }
  ...
  public static String mfc2ansi(@NotNull String s)
  {
    ...
    {
      ColorUtil color = new ColorUtil(Type.MFC, find);
  ...
  {
    string = ColorUtil.and2mfc(string);
    string = ColorUtil.chatHEX2MFC(string);
    string = ColorUtil.chatRGB2MFC(string);
    string = ColorUtil.chatHSL2MFC(string);
    string = ColorUtil.chatCMYK2MFC(string);
    return string;
  }
