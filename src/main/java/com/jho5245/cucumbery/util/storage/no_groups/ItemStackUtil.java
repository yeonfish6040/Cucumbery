...
public class ItemStackUtil
{
    ...
    return switch (type)
            {
              ...
              case BLACK_CARPET, BLUE_CARPET, BROWN_CARPET, CYAN_CARPET, GRAY_CARPET, GREEN_CARPET, LIGHT_BLUE_CARPET, LIGHT_GRAY_CARPET, LIME_CARPET, MAGENTA_CARPET, ORANGE_CARPET, PINK_CARPET, PURPLE_CARPET, RED_CARPET, WHITE_CARPET, YELLOW_CARPET ->
                      3.35;
              case ACACIA_BUTTON, BIRCH_BUTTON, DARK_OAK_BUTTON, MANGROVE_BUTTON, JUNGLE_BUTTON, OAK_BUTTON, SPRUCE_BUTTON, CHERRY_BUTTON, BAMBOO_BUTTON,
                      BOWL,
                      ACACIA_SAPLING, BIRCH_SAPLING, DARK_OAK_SAPLING, MANGROVE_PROPAGULE, JUNGLE_SAPLING, OAK_SAPLING, SPRUCE_SAPLING, CHERRY_SAPLING,
                      STICK,
                      BLACK_WOOL, BLUE_WOOL, BROWN_WOOL, CYAN_WOOL, GRAY_WOOL, GREEN_WOOL, LIGHT_BLUE_WOOL, LIGHT_GRAY_WOOL, LIME_WOOL, MAGENTA_WOOL, ORANGE_WOOL, PINK_WOOL, PURPLE_WOOL, RED_WOOL, WHITE_WOOL, YELLOW_WOOL, AZALEA, FLOWERING_AZALEA ->
                      5;
              case ACACIA_SLAB, BIRCH_SLAB, DARK_OAK_SLAB, MANGROVE_SLAB, JUNGLE_SLAB, OAK_SLAB, SPRUCE_SLAB, CHERRY_SLAB, BAMBOO_SLAB -> 7.5;
              case ACACIA_DOOR, BIRCH_DOOR, DARK_OAK_DOOR, MANGROVE_DOOR, JUNGLE_DOOR, OAK_DOOR, SPRUCE_DOOR, CHERRY_DOOR, BAMBOO_DOOR,
                      ACACIA_SIGN, BIRCH_SIGN, DARK_OAK_SIGN, MANGROVE_SIGN, JUNGLE_SIGN, OAK_SIGN, SPRUCE_SIGN, CHERRY_SIGN, BAMBOO_SIGN,
                      WOODEN_AXE, WOODEN_HOE, WOODEN_PICKAXE, WOODEN_SHOVEL, WOODEN_SWORD -> 10;
              case ACACIA_LOG, BIRCH_LOG, DARK_OAK_LOG, MANGROVE_LOG, JUNGLE_LOG, OAK_LOG, SPRUCE_LOG, CHERRY_LOG,
                      STRIPPED_ACACIA_LOG, STRIPPED_BIRCH_LOG, STRIPPED_DARK_OAK_LOG, STRIPPED_MANGROVE_LOG, STRIPPED_JUNGLE_LOG, STRIPPED_OAK_LOG, STRIPPED_SPRUCE_LOG, STRIPPED_CHERRY_LOG,
                      ACACIA_WOOD, BIRCH_WOOD, DARK_OAK_WOOD, MANGROVE_WOOD, JUNGLE_WOOD, OAK_WOOD, SPRUCE_WOOD, CHERRY_WOOD,
                      STRIPPED_ACACIA_WOOD, STRIPPED_BIRCH_WOOD, STRIPPED_DARK_OAK_WOOD, STRIPPED_MANGROVE_WOOD, STRIPPED_JUNGLE_WOOD, STRIPPED_OAK_WOOD, STRIPPED_SPRUCE_WOOD, STRIPPED_CHERRY_WOOD,
                      ACACIA_PLANKS, BIRCH_PLANKS, DARK_OAK_PLANKS, MANGROVE_PLANKS, JUNGLE_PLANKS, OAK_PLANKS, SPRUCE_PLANKS, CHERRY_PLANKS, BAMBOO_PLANKS,
                      ACACIA_STAIRS, BIRCH_STAIRS, DARK_OAK_STAIRS, MANGROVE_STAIRS, JUNGLE_STAIRS, OAK_STAIRS, SPRUCE_STAIRS, CHERRY_STAIRS, BAMBOO_STAIRS,
                      ACACIA_PRESSURE_PLATE, BIRCH_PRESSURE_PLATE, DARK_OAK_PRESSURE_PLATE, MANGROVE_PRESSURE_PLATE, JUNGLE_PRESSURE_PLATE, OAK_PRESSURE_PLATE, SPRUCE_PRESSURE_PLATE, CHERRY_PRESSURE_PLATE, BAMBOO_PRESSURE_PLATE,
                      ACACIA_TRAPDOOR, BIRCH_TRAPDOOR, DARK_OAK_TRAPDOOR, MANGROVE_TRAPDOOR, JUNGLE_TRAPDOOR, OAK_TRAPDOOR, SPRUCE_TRAPDOOR, CHERRY_TRAPDOOR, BAMBOO_TRAPDOOR,
                      ACACIA_FENCE_GATE, BIRCH_FENCE_GATE, DARK_OAK_FENCE_GATE, MANGROVE_FENCE_GATE, JUNGLE_FENCE_GATE, OAK_FENCE_GATE, SPRUCE_FENCE_GATE, CHERRY_FENCE_GATE, BAMBOO_FENCE_GATE,
                      ACACIA_FENCE, BIRCH_FENCE, DARK_OAK_FENCE, MANGROVE_FENCE, JUNGLE_FENCE, OAK_FENCE, SPRUCE_FENCE, CHERRY_FENCE, BAMBOO_FENCE,
                      BAMBOO_BLOCK, BAMBOO_MOSAIC, STRIPPED_BAMBOO_BLOCK,
                      BEEHIVE, BEE_NEST,
              ...
              case ACACIA_BOAT, BIRCH_BOAT, DARK_OAK_BOAT, MANGROVE_BOAT, JUNGLE_BOAT, OAK_BOAT, SPRUCE_BOAT, CHERRY_BOAT, BAMBOO_RAFT,
                      ACACIA_CHEST_BOAT, BIRCH_CHEST_BOAT, DARK_OAK_CHEST_BOAT, MANGROVE_CHEST_BOAT, JUNGLE_CHEST_BOAT, OAK_CHEST_BOAT, SPRUCE_CHEST_BOAT, CHERRY_CHEST_BOAT, BAMBOO_CHEST_RAFT -> 60;
   ...
   * <p>
   * stick{display:{Name:'{"text":"foo","italic":false}'},Enchantments:[{id:"minecraft:sharpness",lvl:3s}]} = {@link Enchantment#DAMAGE_ALL} 인챈트 레벨 3이 부여된 foo 라는 이름의 {@link Material#STICK}
   *
   * @param sender 제작할 때 오류 발생 시 메시지를 보낼 개체
   * @param input  명령어 형식의 아이템
   ...
   * @param sender 제작할 때 오류 발생 시 메시지를 보낼 개체
   * @param input  명령어 형식의 아이템
   * @param notice 제작 실패 시 오류 메시지 출력 여부
   * @return 제작된 아이템 또는 null
   */
  @Nullable
