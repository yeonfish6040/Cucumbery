...
public class ColorUtil
{
  ...
  public ColorUtil(Type type, String s)
  {
    switch (type)
    {
      case HEX -> {
  ...
  public static String rgb2mfc(String s)
  {
    ...
    {
      ColorUtil color = new ColorUtil(Type.RGB, find);
  ...
  public static String hex2mfc(String s)
  {
    ...
    for (String find : matches)
    {
      ColorUtil color = new ColorUtil(Type.HEX, find);
      s = s.replace(find, color.getMFC());
    }
    return s;
  }
  ...
  public static String cmyk2mfc(String s)
  {
    ...
    for (String find : matches)
    {
      ColorUtil color = new ColorUtil(Type.CMYK, find);
      s = s.replace(find, color.getMFC());
    }
    return s;
  }
  ...
  public static String hsv2mfc(String s)
  {
    ...
    for (String find : matches)
    {
      ColorUtil color = new ColorUtil(Type.HSV, find);
      s = s.replace(find, color.getMFC());
    }
    return s;
  }
  ...
  public static String mfcEffect(String string)
  {
    string = ColorUtil.and2mfc(string);
    string = ColorUtil.getGradientString(string);
    string = ColorUtil.hex2mfc(string);
    string = ColorUtil.rgb2mfc(string);
    string = ColorUtil.cmyk2mfc(string);
    string = ColorUtil.hsl2mfc(string);
    string = ColorUtil.hsv2mfc(string);
    return string;
  }
}