...
public enum Prefix
{
  ...
  INFO_WARP("&b워프", "&d"),
  INFO_WORKBENCH("&e제작대", "&6"),
  INFO_ENDERCHEST("&5엔더상자", "&d"),
  INFO_WHOIS("&d누구쎄요", "&f"),
  INFO_WHATIS("&d뭐야여기", "&f"),
  INFO_LEVEL("&a레벨", "&2"),
  INFO_CLEARCHAT("&e청소채팅", "&2"),
