...
public abstract class CustomPotionEffectType extends PotionEffectTypeWrapper implements Translatable
{
  ...
  public static void onDisable()
  {
    try
    {
      ...
      HashMap<NamespacedKey, PotionEffectType> byKey = (HashMap<NamespacedKey, PotionEffectType>) byKeyField.get(null);
      @SuppressWarnings("unchecked")
      HashMap<String, PotionEffectType> byName = (HashMap<String, PotionEffectType>) byNameField.get(null);
