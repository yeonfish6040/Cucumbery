    ...
    // 커스텀 모델 데이터 설정
    {
      switch (customMaterial)
      {
        case STONK, MINDAS_DRILL, CORE_GEMSTONE, CUTE_SUGAR, BOO, MITHRIL_INGOT,
                ...
                PLATNIUM_INGOT, LEAD_ORE, PLASTIC_DEBRIS, TIN_ORE, NAUTILITE_ORE -> itemMeta.setCustomModelData(25201);
        ...
        case BOO_HUNGRY, CUTE_SUGAR_HUNGRY, TITANIUM_INGOT, EXPERIENCE_BOTTLE_TITANIC, RUNE_EARTHQUAKE, CORE_GEMSTONE_EXPERIENCE,
                ...
                TITANIUM_DRILL_R266, TITANIUM_DRILL_R366, TITANIUM_DRILL_R466, TITANIUM_DRILL_R566, PLASTIC_MATERIAL, PLATNIUM_ORE -> itemMeta.setCustomModelData(25202);
